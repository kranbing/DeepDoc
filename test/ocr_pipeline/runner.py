...
def run_maas_pipeline(
    *,
    ...
    """Run pipeline in MaaS mode, reading API settings from config/env."""
    return run_pipeline(
...
def run_selfhosted_pipeline(
    *,
    ...
    """Run pipeline in selfhosted mode, reading host/port from config."""
    return run_pipeline(
        input_path=input_path,
        output_dir=output_dir,
        doc_id=doc_id,
